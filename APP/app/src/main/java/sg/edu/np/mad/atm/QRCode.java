...
public class QRCode extends AppCompatActivity {
    ...
    private static final String WITHDRAW_URL = "http://172.20.10.2:3001/generate-qr"; // endpoint
   // private static final String WITHDRAW_URL = "https://1219-116-88-162-192.ngrok-free.app/generate-qr"; // endpoint
...
//    }
    ...
    private void deductBalance(String userId, double amount, double currentBalance) {
        ...
        Request request = new Request.Builder()
              .url("http://172.20.10.2:3001/deduct-balance") // endpoint
          //      .url("https://1219-116-88-162-192.ngrok-free.app/deduct-balance")
                .post(body)
                .build();
